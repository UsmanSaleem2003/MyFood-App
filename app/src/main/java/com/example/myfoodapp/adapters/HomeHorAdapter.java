...
public class HomeHorAdapter extends RecyclerView.Adapter<HomeHorAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull HomeHorAdapter.ViewHolder holder, int position)
    {
        ...
        if(check)
        {
            ...
            homeVerModels.add(new HomeVerModel(R.drawable.pizza2, "Pizza", "10:00 - 23:00", "4.9", "Min - $34"));
            homeVerModels.add(new HomeVerModel(R.drawable.pizza3, "Pizza", "10:00 - 23:00", "4.9", "Min - $34"));
            homeVerModels.add(new HomeVerModel(R.drawable.pizza4, "Pizza", "10:00 - 23:00", "4.9", "Min - $34"));
            ...
            holder.cardView.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View view)
                {
                    ...
                    else if(position == 2)
                    {
                        ...
                        homeVerModels.add(new HomeVerModel(R.drawable.fries4, "fries 2","10:00 - 23:00","4.9","Min - $34"));
                    ...
                    else if(position == 3)
                    {
                        ...
                        homeVerModels.add(new HomeVerModel(R.drawable.icecream4, "ice-cream 2","10:00 - 23:00","4.9","Min - $34"));
                    ...
                    else if(position == 4)
                    {
                        ...
                        homeVerModels.add(new HomeVerModel(R.drawable.sandwich1, "sandwhich 1","10:00 - 23:00","4.9","Min - $34"));
                        homeVerModels.add(new HomeVerModel(R.drawable.sandwich2, "sandwhich 2","10:00 - 23:00","4.9","Min - $34"));
                        homeVerModels.add(new HomeVerModel(R.drawable.sandwich3, "sandwhich 3","10:00 - 23:00","4.9","Min - $34"));
                        homeVerModels.add(new HomeVerModel(R.drawable.sandwich4, "sandwhich 2","10:00 - 23:00","4.9","Min - $34"));
